...
As a Product Manager, I am responsible for estimating the revenue for the features and capabilities that I propose to be built. Over the last several months, I have been doing revenue estimation for the features and capabilities that I own in the app. I even talked about it in [my last blog](https://shubhanshugupta.com/3-months-of-product-management-7-learnings/#2-projects-estimations-and-forecasts) how I had to build up a hypothesis, estimate revenue to project the value of the feature, when I had recently joined as a product manager. In this blog, I will be talking about how I went from idea to an impact stage, and an actual example on how to estimate projected revenue for a new feature. So let's dive in!
