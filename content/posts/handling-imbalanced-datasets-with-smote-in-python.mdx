...
![An imbalanced dataset example](/images/posts/handling-imbalanced-datasets-with-smote-in-python/imbalance-dataset.jpg)
...
![Example of how SMOTE generates a new synthetic data point](/images/posts/handling-imbalanced-datasets-with-smote-in-python/SMOTEs-new-synthetic-data-point.jpg)
...
![A balanced dataset](/images/posts/handling-imbalanced-datasets-with-smote-in-python/balanced-dataset.jpg)
*A Balanced Dataset*
...
![Decision boundary of SVM with balanced dataset](/images/posts/handling-imbalanced-datasets-with-smote-in-python/SVM-Trained-balanced-dataset.jpg)
...
![An imbalanced dataset](/images/posts/handling-imbalanced-datasets-with-smote-in-python/heavily-imbalanced-dataset.jpg)
...
![decision boundary of SVM](/images/posts/handling-imbalanced-datasets-with-smote-in-python/SVM-Decision-boundary.jpg)
*Just blue.*
...
![data set balanced with smote'd data](/images/posts/handling-imbalanced-datasets-with-smote-in-python/SMOTE-enhanced-dataset.jpg)
...
![Dataset balanced with synthetic data](/images/posts/handling-imbalanced-datasets-with-smote-in-python/SMOTE-enhanced-dataset2.jpg)
*Still not a blob of red data*

With k=8 we can observe a more vibrant, spherical, and classic looking dataset.

![Using SMOTE with 8 nearest neighbors](/images/posts/handling-imbalanced-datasets-with-smote-in-python/SMOTE-enhanced-dataset3.jpg)
...
![Comparison of balanced model and smote'd model hyperplanes](/images/posts/handling-imbalanced-datasets-with-smote-in-python/Balanced-and-SMOTEd-model.jpg)
